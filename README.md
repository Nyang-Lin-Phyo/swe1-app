...
](https://app.travis-ci.com/Nyang-Lin-Phyo/swe1-app.svg?token=WdnCtTAxCxeHAxswYpPC&branch=main)
...
This repo contains my Django project for CSGY6063/SWE homework with CI/CD via Travis CI.
